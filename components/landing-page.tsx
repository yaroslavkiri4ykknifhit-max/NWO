      ...
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-12">
          <div className="lg:col-span-7 lg:pr-8">
            <h2 className="mb-6 font-display text-4xl font-bold tracking-tight text-black sm:text-5xl md:text-6xl lg:text-[4rem] leading-[1.05] italic">
            ...
            <p className="font-display text-lg leading-relaxed text-gray-800">
              Если вы хотите превратить продажи из стресса в управляемый и прогнозируемый процесс, где вы контролируете каждый этап сделки — от первого контакта до высокого чека.
            </p>
...
const stats = [
  { value: "$11 000", label: "Заработано в 17 лет за три месяца" },
  { value: "2+", label: "Года практики в продажах" },
  { value: "1000+", label: "Холодных звонков и живых переговоров" },
  { value: "$170", label: "Инвестиция в месяц менторства" },
]

const principles = [
  {
    title: "Практика, а не теория",
    body: "Каждый урок рождён из реальных звонков и сделок, а не заимствован из чужих презентаций.",
  },
  {
    title: "Страх — первое возражение",
    body: "Прежде чем отвечать клиенту «нет», вы научитесь справляться с собственным сопротивлением.",
  },
  {
    title: "Контроль над процессом",
    body: "Продажи становятся предсказуемыми, когда вы владеете каждым этапом — от выхода на контакт до закрытия.",
  },
]
...
function ResultsSection() {
  return (
    <section id="results" className="border-b border-gray-300 bg-[#f7f7f5] py-10 md:py-14">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        <SectionHeader title="Результаты и принципы" subtitle="Что лежит в основе метода" />
          ...
          <div className="lg:col-span-4">
            <div className="border-t-4 border-black bg-white p-5 md:p-6 shadow-sm border-x border-b border-gray-200">
              ...
              <p className="font-display text-sm italic leading-relaxed text-gray-800">
                «Если вы хотите превратить продажи из стресса в управляемый и прогнозируемый процесс, где
                контролируете каждый этап сделки — добро пожаловать в New Way Out.»
              </p>
